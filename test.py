...
chutiya_image = face_recognition.load_image_file("C:\\Users\\kunal chaudhai\\Desktop\\Face recognition trial\\images\\messi\\4bb896f0-1753-4eb5-8700-2bf2a2823d65.jpg")
chutiya_encoding = face_recognition.face_encodings(chutiya_image)[0]
...
known_face_names = [
    ...
    "Shreya",
    "Kashish",
    "Chutiya"  # Corrected the name here
]
